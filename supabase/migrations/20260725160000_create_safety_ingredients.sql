...
VALUES
  ...
  ('Arbutin (Alpha)', 'Tyrosinase inhibitor', 'safe', 'Global', '2% (EU guideline)', 'Considered safe. Avoid >3% without dermatologist guidance.'),
  ...
  ('Ascorbic Acid (L-Ascorbic Acid)', 'Antioxidant, collagen synthesis', 'safe', 'Global', '20%', 'Pure Vitamin C. Highly safe. Most effective at 10–20% concentration, but highly unstable and prone to oxidation.'),
  ...
  ('Octinoxate (Ethylhexyl Methoxycinnamate)', 'Chemical UV filter', 'caution', 'Global', '7.5% (US)', 'Chemical sunscreen filter. Safe up to 7.5%, but banned in Hawaii and key reef zones due to coral bleaching.'),
  ('Avobenzone', 'Chemical UVA filter', 'safe', 'Global', '3% (US)', 'Standard UVA filter. Globally approved up to 3% (US) / 5% (EU). Highly photo-unstable; usually paired with Octocrylene to remain stable.'),
  ...
  ('Bakuchiol', 'Antioxidant, retinol alternative', 'safe', 'Global', '1%', 'Natural plant extract. Highly safe retinol alternative. Safe during pregnancy, non-photosensitizing, and soothing.'),
  ...
  ('Hyaluronic Acid', 'Humectant, hydration', 'safe', 'Global', '2% common', 'Highly safe and natural component of the skin. Retains up to 1000x its weight in water to plump and hydrate.')
